class User:
    ...
    def inc_progress(self, activity_rank):
        ...
        if self.rank == 8:
            self.progress = 0
            return
        rank_difference = self.ranks.index(activity_rank) - self.rank_index
...
user.inc_progress(-5)   # Adds 90 progress
print(user.progress)    # => 0 (progress resets after rank upgrade)
print(user.rank)        # => -7 (rank upgraded to -7)
...
Link:https://www.codewars.com/kata/51fda2d95d6efda45e00004e/python
"""
